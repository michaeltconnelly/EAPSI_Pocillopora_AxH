...
echo "Core diversity analyses started"

### Run core diversity metrics analysis on reads rareified to a depth of 2,600
qiime diversity core-metrics-phylogenetic \
--i-phylogeny ${prodir}/outputs/qiime2/qza/all_gg_rooted-tree.qza \
...
qiime diversity alpha-rarefaction \
  ...
  --p-max-depth 12000 \
  --m-metadata-file ./metadata/metadata_all.tsv \
  --o-visualization ${prodir}/outputs/qiime2/qzv/all_gg_alpha-rarefaction.qzv
...
qiime taxa barplot \
  ...
  --m-metadata-file ./metadata/metadata_all.tsv \
  --o-visualization ${prodir}/outputs/qiime2/qzv/all_gg_barplot_no-mtcp.qzv \

  qiime feature-table summarize \
  --i-table ./core-metrics-results_gg/rarefied_table.qza \
  --o-visualization ${prodir}/outputs/qiime2/qzv/all_gg_rarefied_table.qzv

##move qza and qzv from diversity analyses to appropriate folders
#mv ./core-metrics-results_gg/*.qza ${prodir}/outputs/qiime2/qza/
#mv ./core-metrics-results_gg/*.qzv ${prodir}/outputs/qiime2/qzv/

bash ${prodir}/bash/qiime2/all_export_gg_qiime2.sh
