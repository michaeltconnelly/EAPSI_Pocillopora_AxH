...
qiime feature-classifier classify-sklearn \
  ...
  --i-reads ${prodir}/outputs/qiime2/qza/all_rep-seqs.qza \
  --o-classification ${prodir}/outputs/qiime2/qza/all_classification_gg.qza

qiime metadata tabulate \
  --m-input-file ${prodir}/outputs/qiime2/qza/all_classification_gg.qza \
  --o-visualization ${prodir}/outputs/qiime2/qzv/all_classification_gg.qzv

qiime taxa filter-seqs \
  --i-sequences ${prodir}/outputs/qiime2/qza/all_rep-seqs.qza \
  --i-taxonomy ${prodir}/outputs/qiime2/qza/all_classification_gg.qza \
  --p-exclude mitochondria,chloroplast \
  --o-filtered-sequences ${prodir}/outputs/qiime2/qza/all_gg_rep-seqs-no-mtcp.qza
qiime feature-table tabulate-seqs \
  --i-data ${prodir}/outputs/qiime2/qza/all_gg_rep-seqs-no-mtcp.qza \
  --o-visualization ${prodir}/outputs/qiime2/qzv/all_gg_rep-seqs-no-mtcp_rep-seqs.qzv

qiime taxa filter-table \
  --i-table ${prodir}/outputs/qiime2/qza/all_table.qza \
  --i-taxonomy ${prodir}/outputs/qiime2/qza/all_classification_gg.qza \
  --p-exclude mitochondria,chloroplast \
  --o-filtered-table ${prodir}/outputs/qiime2/qza/all_gg_table-no-mtcp.qza
qiime feature-table summarize \
  --i-table ${prodir}/outputs/qiime2/qza/all_gg_table-no-mtcp.qza \
  --o-visualization ${prodir}/outputs/qiime2/qzv/all_gg_table-no-mtcp.qzv \

qiime phylogeny align-to-tree-mafft-fasttree \
--i-sequences ${prodir}/outputs/qiime2/qza/all_gg_rep-seqs-no-mtcp.qza \
--o-alignment ${prodir}/outputs/qiime2/qza/all_gg_aligned-rep-seqs-no-mtcp.qza \
--o-masked-alignment ${prodir}/outputs/qiime2/qza/all_gg_masked-aligned-rep-seqs-no-mtcp.qza \
--o-tree ${prodir}/outputs/qiime2/qza/all_gg_unrooted-tree.qza \
--o-rooted-tree ${prodir}/outputs/qiime2/qza/all_gg_rooted-tree.qza
...
bash ${prodir}/bash/qiime2/all_diversity_gg_qiime2.sh
