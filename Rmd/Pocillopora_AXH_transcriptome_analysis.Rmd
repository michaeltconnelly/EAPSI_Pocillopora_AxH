...
# Get DESeq results for all treatment contrasts for each colony
...
```{r KOG, results = 'hide'}
# Import KOG annotations for P. damicornis genome
gene2kog <- read.table("./data/pdam_gene2kogClass.tab", sep = "\t") %>% 
   filter(!V2 == "")
