...
pdf(file = "~/computing/scripts/EAPSI_AntiXHeat-master/DESeqresults_Pdam/figures/Volcano_anti_ctrl-ctrl.pdf", height = 3, width = 4.25)
...
```{r, warning = FALSE}
DEGcolors <- c("red", "blue", "black")
pdf(file = "~/computing/scripts/EAPSI_AntiXHeat-master/DESeqresults_Pdam/figures/Volcano_heat_ctrl-ctrl.pdf", height = 3, width = 4.25)
...
```{r, warning = FALSE}
DEGcolors <- c("red", "blue", "black")
pdf(file = "~/computing/scripts/EAPSI_AntiXHeat-master/DESeqresults_Pdam/figures/Volcano_anti.heat_ctrl-ctrl.pdf", height = 3, width = 4.25)
...
pdf(file = "~/computing/scripts/EAPSI_AntiXHeat-master/DESeqresults_Pdam/figures/Volcano_anti_ctrl_colonies.pdf", height = 3, width = 4.25)
...
```{r, warning = FALSE}
DEGcolors <- c("red", "blue", "dark grey")
pdf(file = "~/computing/scripts/EAPSI_AntiXHeat-master/DESeqresults_Pdam/figures/Volcano_heat_ctrl_colonies.pdf", height = 3, width = 4.25)
...
```{r, warning = FALSE}
DEGcolors <- c("red", "blue", "dark grey")
pdf(file = "~/computing/scripts/EAPSI_AntiXHeat-master/DESeqresults_Pdam/figures/Volcano_anti.heat_ctrl_colonies.pdf", height = 3, width = 4.25)
