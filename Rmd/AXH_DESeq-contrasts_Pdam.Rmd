...
###
res_anti_ctrl$ID <- mcols(dds_anti)$ID
res_anti_ctrl$GeneInfo <- mcols(dds_anti)$GeneInfo
res_anti_ctrl$KO_terms <- mcols(dds_anti)$KO_terms
res_anti_ctrl$Pfam_domains <- mcols(dds_anti)$Pfam_domains
res_anti_ctrl$ID <- as.character(res_anti_ctrl$ID)
res_anti_ctrl$GeneInfo <- as.character(res_anti_ctrl$GeneInfo)
res_anti_ctrl$KO_terms <- as.character(res_anti_ctrl$KO_terms)
res_anti_ctrl$Pfam_domains <- as.character(res_anti_ctrl$Pfam_domains)
###
...
###
res_heat_ctrl$ID <- mcols(dds_heat)$ID
res_heat_ctrl$GeneInfo <- mcols(dds_heat)$GeneInfo
res_heat_ctrl$KO_terms <- mcols(dds_heat)$KO_terms
res_heat_ctrl$Pfam_domains <- mcols(dds_heat)$Pfam_domains
res_heat_ctrl$ID <- as.character(res_heat_ctrl$ID)
res_heat_ctrl$GeneInfo <- as.character(res_heat_ctrl$GeneInfo)
res_heat_ctrl$KO_terms <- as.character(res_heat_ctrl$KO_terms)
res_heat_ctrl$Pfam_domains <- as.character(res_heat_ctrl$Pfam_domains)
###
...
###
res_anti.heat_ctrl$ID <- mcols(dds_anti.heat)$ID
res_anti.heat_ctrl$GeneInfo <- mcols(dds_anti.heat)$GeneInfo
res_anti.heat_ctrl$KO_terms <- mcols(dds_anti.heat)$KO_terms
res_anti.heat_ctrl$Pfam_domains <- mcols(dds_anti.heat)$Pfam_domains
res_anti.heat_ctrl$ID <- as.character(res_anti.heat_ctrl$ID)
res_anti.heat_ctrl$GeneInfo <- as.character(res_anti.heat_ctrl$GeneInfo)
res_anti.heat_ctrl$KO_terms <- as.character(res_anti.heat_ctrl$KO_terms)
res_anti.heat_ctrl$Pfam_domains <- as.character(res_anti.heat_ctrl$Pfam_domains)
###
