...
```{r}
pdf(file = "./outputs/DESeq-results/figuresPCA_0_trmt_AXH.pdf", height = 5.5, width = 8.5)
...
```
```{r}
#pdf(file = "./outputs/DESeq-results/figuresPCAs_AXH.pdf", height = 4, width = 8)
...
```
```{r}
pdf(file = "./outputs/DESeq-results/figures/PCAs_anti_ctrl.pdf", height = 4, width = 8)
...
```
```{r}
pdf(file = "./outputs/DESeq-results/figures/PCAs_heat_ctrl.pdf", height = 4, width = 8)
...
```
```{r}
pdf(file = "./outputs/DESeq-results/figures/PCAs_anti.heat_ctrl.pdf", height = 4, width = 8)
...
```
```{r}
pdf(file = "./outputs/DESeq-results/figures/PCAs_AXH_colfacet.pdf", height = 4, width = 8)
...
```
```{r, message=FALSE}
pdf(file = "./outputs/DESeq-results/figures/PCAs_colony_AXH.pdf", height = 5.5, width = 8.5)
