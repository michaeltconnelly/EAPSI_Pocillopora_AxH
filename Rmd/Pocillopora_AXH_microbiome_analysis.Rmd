...
### samples collapsed into colonies
pdf(file = "./manuscript_figures/Fig3B_RelAbundBarplot.pdf", width = 6.5, height = 4.5)
...
### create custom color palette for 39 bacteria families
  ...
  theme(legend.position = "bottom",
        ...
        axis.title = element_text(margin = margin(c(5,2,5,2), unit = "mm")))
p_family2
...
ps.AXH_richness$ID <- rownames(ps.AXH_richness)
...
chao1 <- plot_richness(ps.AXH, x="Treatment", measures=c("Chao1")) +
  ...
  theme(legend.position = "none",
        ...
        strip.text = element_blank())
chao1
ggsave(chao1, filename = "./outputs/phyloseq-results/figures/chao1boxplot.pdf", device = "pdf", width = 4, height = 3)
```
```{r shannon_boxplot}
