# facet_nested
# taken from: https://github.com/teunbrand/ggh4x/blob/master/R/facet_nested.R
# based on: https://stackoverflow.com/questions/40316169/nested-facets-in-ggplot2-spanning-groups
# Main function -----------------------------------------------------------
